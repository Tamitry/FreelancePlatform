    ...
    <div class="content">
        ...
        <div class="main">
            <form action="saveprofile.html" method="post" class="form">
                <p><fmt:message key="firstname"/>: <input type="text" placeholder=<fmt:message key="firstname"/> value="${user.firstName}" name="firstname"></p>
                <p><fmt:message key="lastname"/>: <input type="text" placeholder=<fmt:message key="lastname"/> value="${user.lastName}" name="lastname"></p>
                ...
                <button type="reset" name="<fmt:message key="reset"/>">Reset</button>
            </form>
        </div>
    </div>
</div>
